...
export default function AppPage() {
    ...
    // FIXME: add all the other gubbins in here...

  return (
    <div className="Content">
        App page gonna WAGMI!
      {/*
               {!isValidL1 ? (
                 <div>
                   unable to detect valid network. please connect to the kovan l1
                   testnet
                 </div>
               ) : (
                 <></>
               ...
               <header className="App-header">
                 <div>
                   <StyledButton onClick={() => toggleLoadModal()}>
                     load
                   </StyledButton>
                   <span>&gt;</span>
