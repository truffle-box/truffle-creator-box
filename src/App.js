...
function App() {
  ...
  const contract = new ethers.Contract("0xEb56A7AE1557117Acd1bBeA07D2053035f352b7b", abi, l1Signer || l1Provider);
    ...
    <Switch>
      ...
      <Route path="/gallery">
        <div className="App">
          ...
          <Gallery contract={contract} contractArbitrum={contractArbitrum} walletDetected={walletDetected} />
        </div>
      </Route>
      <Route path="/about">
        <div className="App">
